...
const qnaData = [
  ...
  },
  {
    ...
    answer: '원작 드라마를 참고하여 교복 착용 부탁드리며, 원형을 크게 훼손하지 않는 선에서 리폼이 가능합니다. (ex. 원작에서 웬즈데이의 교복이 검정 톤으로 바뀐 것, 에이잭스 캐릭터가 교복 재킷 안에 지퍼형 후드를 입은 것, 치마 길이 등의 수선, 바지 폭 조정, 크로스드레싱 등)\n최종 리폼 형태가 애매하다고 판단되신다면, QnA 창구에 문의해 주셔도 괜찮습니다. 내부 협의 후 답변드리도록 하겠습니다.',
  },
  {
    id: 2,
