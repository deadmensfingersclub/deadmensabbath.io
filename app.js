...
const qnaData = [
  {
    id: 4,
    title: '가입 후 활동 승인까지 얼마나 걸리나요?',
    category: '가입',
    date: '2026-04-10',
    question: '가입 신청서를 제출했는데, 승인까지 얼마나 기다려야 하나요?',
    answer: '신청서 검토는 운영진 일정에 따라 최대 7일 이내에 이루어집니다.\n급한 사정이 있는 경우 QNA 혹은 건의 창구를 통해 연락해주시면 우선 처리해 드립니다.',
  },
  {
    id: 3,
    title: '캐릭터 설정 수정은 어떻게 요청하나요?',
    category: '신청·수정',
    date: '2026-04-08',
    question: '이미 승인된 캐릭터의 설정(이름, 나이, 배경 등)을 일부 수정하고 싶습니다. 어떤 절차를 밟아야 하나요?',
    answer: '승인 이후 설정 변경이 필요한 경우, QNA 게시판 또는 운영진 연락처를 통해\n수정 요청서를 제출해 주세요.\n변경 범위와 사유를 명확히 기재해 주시면 빠르게 검토해 드립니다.',
  },
  {
    id: 2,
    title: '커뮤니티 활동 중 다른 자캐와 마찰이 생겼을 때는?',
    category: '운영·규칙',
    date: '2026-04-05',
    question: '다른 회원과 설정 충돌 또는 분쟁이 발생했습니다. 어떻게 처리하나요?',
    answer: '학칙 제3조에 따라, 커뮤니티 내 발생하는 모든 문제는 운영진에게 정식으로 보고해야 합니다.\n당사자 간 직접 해결을 시도하기 전에 먼저 운영진에게 상황을 전달해 주세요.\n개인 간 마찰은 외부에 공개하지 않도록 주의해 주십시오.',
  },
  {
    id: 1,
    title: '〈웬즈데이〉를 원작으로 본 적 없어도 참여할 수 있나요?',
    category: '가입',
    date: '2026-04-01',
    question: '넷플릭스 시리즈 〈웬즈데이〉를 아직 다 보지 못했는데, 가입 및 활동에 제한이 있나요?',
    answer: '시리즈를 완주하지 않아도 가입 자체는 가능합니다.\n다만, 커뮤니티는 〈웬즈데이〉 세계관을 기반으로 운영되므로\n최소한 작품의 주요 설정(네버모어 아카데미, 아웃캐스트, 노말 등)을 숙지하시길 권장합니다.\n세계관 페이지를 먼저 읽어보시면 참고가 됩니다.',
  },
];
...
const pages = {
    ...
    const regHtml = `
      ...
      <div class="regulation-list">
        ...
        <div class="regulation-item">
          ...
          <div class="regulation-body">본 커뮤니티는 <strong>2차 지인제</strong>로 <strong>2007년 이전 출생자만 신청서 제출</strong>이 가능합니다. 연령 허위 기재, 신원 사칭, 아이디 도용 등을 금지하며 적발 시 사전 고지 없이 즉시 제명 처리합니다. 제명 대상자는 커뮤니티에서 처음부터 존재하지 않았던 캐릭터로 취급하며 연락처 공유와 애프터 참여가 불가합니다.</div>
        </div>
  ...
  worldview: () => `
    ...
    <p><strong>1967년 3월 26일 일요일.</strong><br>나비난초회 전원은 부활절을 맞이하여 <strong>'소원을 들어주는 의식'</strong>을 진행했다. 그쯤 동아리에는 상반기 활동 보고서로 제출할 만한 일이 필요했고, 누군가가 꺼낸 '소원 들어주는 의식' 이야기가 동아리 인원 과반수의 흥미를 당긴 탓이었다─그 외 마땅한 의견을 낸 학생이 없기도 했다. 이런 이유로 당신은 <strong>네버모어 아카데미 내부와 근처 마을에서 '소원을 들어주는 의식'에 필요한 재료를 조달</strong>했다. 모든 준비를 마치기까지는 약 보름의 시간이 걸렸다.</p>
  ...
  application: () => `
    <div class="app-page">
      ...
      공백 포함 최대 1000자 이내로 서술 부탁드립니다.</p>
